        ...
        <div class="container">
          ...
          <div class="step-wrap">
            ...
            <div class="step-form">
                ...
                <div class="step-polis">
                  <div class="input-wrapper">
                    <label class="input-label">
                      <input required class="input input--big user_name" v-model="user_name" type="text"
                             placeholder="Имя"/>
                  ...
                  <div class="input-wrapper">
                    <label class="input-label">
                      <input required class="input input--big user_surname" v-model="user_surname" type="text"
                             placeholder="Фамилия"/>
                      <div class="input__placeholder">
                        <span>Фамилия</span>
                      </div>
                  ...
                  <div class="input-wrapper input-wrapper--small">
                    <label class="input-label">
                      <input required class="input input--big j_date-mask user_birsday" maxlength="10"
                             v-on:change="isChangeBirsday" v-model="user_birsday" type="text"
                  ...
                  <div class="input-wrapper input-wrapper-datepicker input-wrapper--small">
                    ...
                    <label data-datepicker-min="3" class="input-label datepicker j_datepicker">
                      <input required class="input input--big user_activate" type="text" v-on:change="isChangeActivate"
                             v-model="user_activate" placeholder="Дата активации полиса"/>
                      <div class="input__placeholder">
              ...
              <button class="button submit-button" type="button" v-on:click="sendActivate()">
                Активировать полис
              </button>
            </div>
            <!-- ./ End of form -->
    ...
    sendActivate() {
      ...
      if (this.user_birsday.length == 0)
        ...
        if (!this.validate_date(user_birsday))
          this.errors.push({user_birsday: "Вы неверную дату рождения"})
      }

      if (!this.user_activate) {
        this.errors.push({user_activate: "Вы не ввели дату активации полиса"})
      } else
