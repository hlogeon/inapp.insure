			  	...
			  	<div class="polis-info-wrap">
			  	  <div class="polis-info-inputs">
			  	    ...
			  	    <div class="input-wrapper" style="margin: 0;">
			  	    	<label class="input-label" v-if="current.status_id == 4 || current.subscribed == 0">
			  	    		<input required="required" type="tel" placeholder="Карта" readonly="readonly" class="input input--big input--transparent" value="Отключено"> 
			  	    		<div class="input__placeholder">
			  	    	...
			  	    	<div class="settings-table__row" v-else>
			  	    		<div class="settings-table__col input-wrapper">
			  	    			<label class="input-label">
			  	    				<a href="javascript:;" class="settings-table__row-link" @click="infoPage">
			  	    					<svg class="settings-table__row-icon">
			  	    						<use xlink:href="#edit"></use>
			  	    					</svg>
			  	    				</a> 
			  	    				<input required="required" type="tel" placeholder="Карта" readonly="readonly" class="input input--big input--transparent" :value="dateIs(new Date(current.finish))" style="padding-right: 0;"> 
			  	    				<div class="input__placeholder">
			  	    					<span>Автопродление</span>
			  	    				</div>
			  	    			</label>
			  	  ...
			  	  <div class="polis-info-buttons">
			  	    ...
			  	    <a :href="'/get_pdf/'+this.current.id+'/Страховой%20полис.pdf'" target="_blank" class="button button--small" style="margin-left: 0;">
			  	  	  	Страховой полис
			  	  	</a>
			  	    <!-- <a href="javascript:;" class="button button--small" @click="addSecondPolic">
			  	  	...
			  	  	<a href="javascript:;" onclick="document.querySelector('.intercom-launcher').click()" class="button button--small button--red">
			  	  	  	Cтраховой случай
			  	  	</a>
			  	  </div>
			  	</div>
